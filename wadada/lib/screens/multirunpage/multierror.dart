...
class MultiError extends StatefulWidget {
  final StompController controller;
  const MultiError({super.key, required this.controller});

  @override
  _MultiErrorState createState() => _MultiErrorState();
}

class _MultiErrorState extends State<MultiError> {
