...
class MultiTimeRoomDetail extends StatefulWidget {
  const MultiTimeRoomDetail({super.key});

  @override
  _MultiTimeRoomDetailState createState() => _MultiTimeRoomDetailState();
}

class _MultiTimeRoomDetailState extends State<MultiTimeRoomDetail> {
                      ...
                      Row(
                        children: const [
                          ...
                          Column(
                            children: [
                              SizedBox(height: 10),
                              Icon(Icons.watch_later_outlined, color: DARK_GREEN_COLOR, size: 30,),
                              SizedBox(height: 20),
                          ...
                          Column(
                            ...
                            children: [
                              SizedBox(height: 5),
                              Text('시간', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: DARK_GREEN_COLOR),),
                              SizedBox(height: 20),
                          ...
                          Column(
                            ...
                            children: [
                              SizedBox(height: 5),
                              Text('35 분', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: DARK_GREEN_COLOR),),
                              SizedBox(height: 20),
